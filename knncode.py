...
if __name__ == '__main__':
    ...
    for file in glob.glob("./Employee_Photo/test/*"):
        ...
        person_path="./Employee_Photo/test/"+str(p_path)
        f_image=face_recognition.load_image_file(person_path)
        F=face_recognition.face_encodings(f_image)[0]
        f_encodings.append(F)
    # Load a sample picture and learn how to recognize it.

    # obama_image = face_recognition.load_image_file("/home/shitijkarsolia/Desktop/projects/Siamese/Working_Code/dataset/Shitij/Shitij Karsolia Mathur.jpg")
    ...
    # biden_image = face_recognition.load_image_file("/home/shitijkarsolia/Desktop/projects/Siamese/Working_Code/dataset/Kamal/406972000010180053_KAMAL_KESWANI.jpg")
    # biden_face_encoding = face_recognition.face_encodings(biden_image)[0]

    # bharat_image = face_recognition.load_image_file("/home/shitijkarsolia/Desktop/projects/Siamese/Working_Code/dataset/Bhavesh/406972000010247539_20190703_163432-min.jpg")
    # print(type(bharat_image))

    # print(face_recognition.face_encodings(bharat_image)[0])
    # bharat_face_encoding = face_recognition.face_encodings(bharat_image)[0]



    # Global.known_face_encodings = f_encodings
    ...
    #     # "Bhavesh"
    # ]
    Global.known_face_names =f_names

    Global.known_face_encodings = f_encodings
    # Global.known_face_names =face_names
    p[0].start()
